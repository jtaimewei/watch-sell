			...
			<div class="thumbnail rigthDiv">
			  <div class="caption">
				<ul class="nav nav-tabs">
					...
					<li role="presentation"  class="active"><a href="${pageContext.request.contextPath }/a/menu/toadd">添加菜单</a></li>
				</ul>
				<br><br>
				<div class="row">
				
				<div class="col-md-6 col-md-offset-1">
				<form id="addMenuForm" action="${pageContext.request.contextPath }/a/menu/add" method="post">
				 		<div class="input-group input-group-lg">
  							<span class="input-group-addon" id="sizing-addon1">菜单名&nbsp;&nbsp;&nbsp;&nbsp;*</span>
  							<input type="text" id="menuName" name="menuName" class="form-control" aria-describedby="sizing-addon1">
							<p id="menuName-notice" class="menu-notice">*请输入菜单名</p>
						</div>
						<br><br>
						<div class="input-group input-group-lg">
  							<span class="input-group-addon" id="sizing-addon1">访问链接*</span>
  							<input type="text" id="href" name="href" class="form-control" aria-describedby="sizing-addon1">
							<p id="href-notice" class="menu-notice">*请输入访问链接</p>
						</div>
						<br><br>
						<div class="input-group input-group-lg">
  							<span class="input-group-addon" id="sizing-addon1">排序&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*</span>
  							<input type="text" id="sort" name="sort" class="form-control" aria-describedby="sizing-addon1">
							<p id="sort-notice" class="menu-notice">*请输入排序号</p>
						</div>
						<br><br>
						<div class="input-group input-group-lg">
  							<span class="input-group-addon" id="sizing-addon1">访问权限*</span>
  							<input type="text" id="permission" name="permission" class="form-control" aria-describedby="sizing-addon1">
							<p id="permission-notice" class="menu-notice">*请输入访问权限</p>
						</div>
						<br><br>
						
							<button type="button" id="addMenuButton" class="btn btn-primary btn-lg btn-block">添加</button>
