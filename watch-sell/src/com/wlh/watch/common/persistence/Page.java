 ...
 */
package com.wlh.watch.common.persistence;
...
import com.wlh.watch.common.utils.CookieUtils;
...
public class Page<T> {
	...
	public String toString() {
		...
		sb.append("<input style=\"width: 30px;height: 20px;\" type=\"text\" value=\""+pageNo+"\" onkeypress=\"var e=window.event||event;var c=e.keyCode||e.which;if(c==13)");
		sb.append(funcName+"(this.value,"+pageSize+",'"+funcParam+"');\" onclick=\"this.select();\"/> / ");
		sb.append("<input style=\"width: 30px;height: 20px;\" type=\"text\" value=\""+pageSize+"\" onkeypress=\"var e=window.event||event;var c=e.keyCode||e.which;if(c==13)");
